// Function to determine which major was selected and set appropriate title
function setMajorTitle() {
    ...
    if (isCS) {
        ...
        // Default to mathematics for invalid or missing parameter
...
function getCourseList(major) {
    ...
    return mathCourses; // Default to mathCourses
}
...
function setupSemesterButtons() {
    ...
    semesterButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            // Navigate to the plan page with parameters
